...
test_curl "App1 via host IP"             http://10.0.3.20:5001/
test_curl "App2 via host IP"             http://10.0.3.20:5002/
test_curl "App3 via host IP"             http://10.0.3.20:5003/
...
test_curl "External App1/2 via NGINX"    https://10.0.3.20/app1/
test_curl "External App3 via NGINX"      https://10.0.3.20/app3/
